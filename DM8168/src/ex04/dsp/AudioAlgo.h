...
#define AUDIO_ALGO_MODE_PASSTHROUGH      APP_ALGO_MODE_PASSTHROUGH
#define AUDIO_ALGO_MODE_SWAP_STEREO      APP_ALGO_MODE_SWAP_STEREO
#define AUDIO_ALGO_MODE_GAIN_X2          APP_ALGO_MODE_GAIN_X2
